...
function mapStateToProps({ authedUser , users , questions}){
     ...
     //  console.log('all answer',AllAnswers)
       const Answered =    Object.values(questions).filter(question => AllAnswers.includes(question.id)) 
    //console.log('  answer',Answered)

        const UnAnswered =  Object.values(questions).filter(question => !AllAnswers.includes(question.id)) 
